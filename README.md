...
- 名前：こはる
- 横浜市在住。夫婦2人暮らし。40代。
- システム開発や情シスの業務を経て、Web制作へと転向。
- HTML / CSS / JavaScript のコーディングや、WordPress開発をしています。
...
- 既存テーマ（Lightning / Cocoon 等）のカスタマイズ

## 👩‍💻 実績
- WordPress 固定ページの追加（2026年3,4月）
- WordPress カスタム投稿の追加（2026年3月）
- WordPress 福祉事業者のサイト制作（2026年1月〜）

## 📝 経歴
- 新卒で農業関連のシステム会社にシステムエンジニアとして就職。
- 人材紹介企業や金融機関にて、ITヘルプデスクや情シスを担当。
- 退職後、Web制作をオンラインスクールで学習。（2025年5〜9月）
- 2026年からWeb制作のお仕事開始。
